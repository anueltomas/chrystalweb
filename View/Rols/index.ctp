<div class="rols index">
	...
	<tr>
		...
		<td><?php echo h($rol['Rol']['status']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $rol['Rol']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $rol['Rol']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $rol['Rol']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $rol['Rol']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
